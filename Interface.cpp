...
AVSValue __cdecl Create_ErrorAwareBlockFps(AVSValue args, void* user_data, IScriptEnvironment* env)
{
	return new ErrorAwareBlockFps(
		args[0].AsClip(),
		args[1].AsClip(),
		args[2].AsClip(),
		args[3].AsClip(),
...
//	env->AddFunction("MVDenoise", "cc+[Y]b[U]b[V]b[thT]i[thSAD]i[thMV]i[thSCD1]i[thSCD2]i[isse]b", Create_MVDenoise2, 0);
	...
	env->AddFunction("MAnalyse", "c[blksize]i[blksizeV]i[levels]i[search]i[searchparam]i[pelsearch]i[isb]b[lambda]i[chroma]b[delta]i[truemotion]b[lsad]i[plevel]i[global]b[pnew]i[pzero]i[pglobal]i[overlap]i[overlapV]i[outfile]s[dct]i[divide]i[sadx264]i[badSAD]i[badrange]i[isse]b[meander]b[temporal]b[trymany]b", Create_MVAnalyse, 0);
...
//	env->AddFunction("MVInter", "c[mvbw]c[mvfw]c[time]f[mode]i[thres]i[idx]i[thSCD1]i[thSCD2]i[mmx]b[isse]b", Create_MVInter, 0);
	env->AddFunction("MFlow", "ccc[time]f[mode]i[fields]b[thSCD1]i[thSCD2]i[isse]b[planar]b", Create_MVFlow, 0);
	env->AddFunction("MFlowInter", "cccc[time]f[ml]f[blend]b[thSCD1]i[thSCD2]i[isse]b[planar]b", Create_MVFlowInter, 0);
...
//	env->AddFunction("MVFlowFps2", "c[mvbw]c[mvfw]c[mvbw2]c[mvfw2]c[num]i[den]i[mask]i[ml]f[pelclip]c[idx]i[idx2]i[thSCD1]i[thSCD2]i[isse]b", Create_MVFlowFps2, 0);
	env->AddFunction("MDegrain1", "cccc[thSAD]i[thSADC]i[plane]i[limit]i[limitC]i[thSCD1]i[thSCD2]i[isse]b[planar]b", Create_MVDegrain1, 0);
	env->AddFunction("MDegrain2", "cccccc[thSAD]i[thSADC]i[plane]i[limit]i[limitC]i[thSCD1]i[thSCD2]i[isse]b[planar]b", Create_MVDegrain2, 0);
	env->AddFunction("MDegrain3", "cccccccc[thSAD]i[thSADC]i[plane]i[limit]i[limitC]i[thSCD1]i[thSCD2]i[isse]b[planar]b", Create_MVDegrain3, 0);
	env->AddFunction("MRecalculate", "cc[thsad]i[smooth]i[blksize]i[blksizeV]i[search]i[searchparam]i[lambda]i[chroma]b[truemotion]b[pnew]i[overlap]i[overlapV]i[outfile]s[dct]i[divide]i[sadx264]i[isse]b[meander]b", Create_MVRecalculate, 0);
...
//	env->AddFunction("MVFinest", "c[isse]b", Create_MVFinest, 0);
	env->AddFunction("ErrorAwareBlockFps", "c[superClip]c[backwardVectors]c[forwardVectors]c[fpsDivisor]i[fpsMultiplier]i[mode]i", Create_ErrorAwareBlockFps, 0);
